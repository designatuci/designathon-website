...
function About() {
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-1/2 z-10 w-full max-w-xl -translate-x-1/2 -translate-y-1/2 px-[60px] md:px-[104px]">
      ...
      <Image
        ...
        width={400}
        height={400}
        className="pointer-events-none absolute left-1/2 top-1/2 h-[12rem] w-[12rem] -translate-x-1/2 -translate-y-1/2 object-contain md:h-[22rem] md:w-[22rem]"
      />
