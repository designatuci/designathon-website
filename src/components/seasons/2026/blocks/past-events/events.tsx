...
export const eventsList: PlanetConfig[] = [
  {
    ...
    sizeTablet: "md:h-[14rem] md:w-[14rem] lg:h-[15rem] lg:w-[15rem]",
    sizeDesktop: "xl:h-[20rem] xl:w-[20rem]",
    modalContent: {
  ...
  },
  {
    ...
    sizeTablet: "md:h-[15rem] md:w-[15rem] lg:h-[16rem] lg:w-[16rem]",
    sizeDesktop: "xl:h-[22rem] xl:w-[22rem]",
    modalContent: {
      title: "Impact 2022",
      theme: "Impact",
      participants: "100+",
  ...
  },
  {
    ...
    sizeTablet: "md:h-[26rem] md:w-[26rem] lg:h-[27rem] lg:w-[27rem]",
    sizeDesktop: "xl:h-[44rem] xl:w-[44rem]",
    modalContent: {
  ...
  },
  {
    ...
    sizeTablet: "md:h-[28rem] md:w-[28rem] lg:h-[29rem] lg:w-[29rem]",
    sizeDesktop: "xl:h-[55rem] xl:w-[55rem]",
    modalContent: {
