...
const COMMITTEES: Committee[] = [
  {
    ...
    fd: 4.2,
    fdelay: 0,
    description: "The backbone of the event — coordinating venues, schedules, supplies, and making sure everything runs like clockwork on the day of.",
    members: [
  ...
  },
  {
    ...
    fd: 3.8,
    fdelay: 0.5,
    description: "Building and maintaining the Design-a-thon website, registration systems, and all digital touchpoints for participants.",
    members: [
  ...
  },
  {
    ...
    fd: 4.5,
    fdelay: 0.8,
    description: "Managing budgets, reimbursements, and financial planning to ensure the event stays on track and resources are allocated wisely.",
    members: [
  ...
  },
  {
    ...
    fd: 3.6,
    fdelay: 0.3,
    description: "Crafting the visual identity, branding, illustrations, and all design assets that bring the cosmic theme of Design-a-thon to life.",
    members: [
  ...
  },
  {
    ...
    fd: 4.8,
    fdelay: 1.2,
    description: "Spreading the word across social media, email campaigns, and outreach to bring the best designers from across the country.",
    members: [
  ...
  },
  {
    ...
    fd: 5,
    fdelay: 1,
    description: "Securing sponsorships and building relationships with industry partners to make the event possible and rewarding for all participants.",
    members: [
...
export default function MeetCommittees({ onSelectCommittee }: Props) {
  ...
  return (
    ...
    />
    <main className="relative flex min-h-screen w-full flex-col items-center justify-center bg-transparent pb-[15%] pt-[5%]">
        <style>{`
      ...
      {/* Constellation area */}
      <div className="relative overflow-visible z-10 h-[min(90vh,800px)] w-[min(1100px,95vw)]">
        ...
        >
            <div className={`${luxurious.className} script-glow text-8xl font-normal leading-none text-white md:text-9xl xl:text-[6rem] mr-[20%]`}>Meet The</div>
            <div className={`${luxurious.className} script-glow text-8xl font-normal leading-none text-white md:text-9xl xl:text-[9rem] ml-[20%] -mt-6`}>Committees</div>
        </div>
