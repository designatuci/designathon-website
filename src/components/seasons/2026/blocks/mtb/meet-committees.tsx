    ...
    members: [
      {
        name: "Alex Chen",
        role: "Director",
        bio: "Alex leads the web team with 3 years of full-stack experience, specializing in Next.js and design systems.",
      },
      {
        name: "Jamie Park",
        role: "Co-Lead",
        bio: "Jamie architects the frontend, obsessed with performance and pixel-perfect implementation.",
      },
      {
        name: "Casey Wu",
        role: "Engineer",
        bio: "Casey builds backend integrations and keeps the registration system running smoothly.",
      },
      {
        name: "Jordan Patel",
        role: "Designer",
        bio: "Jordan bridges design and engineering, turning Figma files into living interfaces.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Morgan Lee",
        role: "Director",
        bio: "Morgan orchestrates every moving part of the event, from venue setup to day-of schedules.",
      },
      {
        name: "Sam Torres",
        role: "Coordinator",
        bio: "Sam manages vendor relationships and ensures all supplies arrive on time.",
      },
      {
        name: "Riley Kim",
        role: "Coordinator",
        bio: "Riley handles participant communications and keeps the event timeline on track.",
      },
      {
        name: "Drew Park",
        role: "Assistant",
        bio: "Drew supports logistics operations across all fronts of the event.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Sage Miller",
        role: "Director",
        bio: "Sage keeps the event financially healthy, managing a budget across 6 committees.",
      },
      {
        name: "Blake Foster",
        role: "Treasurer",
        bio: "Blake processes all reimbursements and tracks expenses in real time.",
      },
      {
        name: "Rowan Clark",
        role: "Analyst",
        bio: "Rowan builds financial projections and helps the team make data-driven decisions.",
      },
      {
        name: "Avery Lane",
        role: "Assistant",
        bio: "Avery supports financial reporting and budget tracking across all committees.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Indigo Ray",
        role: "Director",
        bio: "Indigo drives the marketing strategy that brought in 400+ applicants last season.",
      },
      {
        name: "Skye Lam",
        role: "Brand Lead",
        bio: "Skye maintains the visual identity across all marketing touchpoints.",
      },
      {
        name: "Phoenix Yu",
        role: "Illustrator",
        bio: "Phoenix creates custom illustrations that make the brand unforgettable.",
      },
      {
        name: "Nova Bell",
        role: "Motion",
        bio: "Nova produces motion graphics and animations for all social content.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Zara Moon",
        role: "Director",
        bio: "Zara defines the creative direction and ensures every detail is intentional.",
      },
      {
        name: "Cruz Vega",
        role: "Social Lead",
        bio: "Cruz manages the social presence and has grown Instagram to 5k+ followers.",
      },
      {
        name: "Ember Walsh",
        role: "Copywriter",
        bio: "Ember writes the words that make people feel the magic of Design-a-thon.",
      },
      {
        name: "Atlas Grey",
        role: "Outreach",
        bio: "Atlas connects with student orgs and clubs to spread the word across campuses.",
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Drew Nguyen",
        role: "Director",
        bio: "Drew leads sponsor outreach and has secured partnerships with 12+ industry leaders.",
      },
      {
        name: "Taylor Moss",
        role: "Outreach",
        bio: "Taylor crafts compelling pitch decks and manages initial sponsor conversations.",
      },
      {
        name: "Avery Singh",
        role: "Partnerships",
        bio: "Avery nurtures long-term sponsor relationships and coordinates participant perks.",
      },
      {
        name: "Quinn Adams",
        role: "Relations",
        bio: "Quinn handles contracts and ensures all partnership agreements are fulfilled.",
      },
    ],
  },
];
